...
//    setAutoFillBackground(true);
    ...
    connect( m_pObjFileRepair, &ObjFileRepair::sigDownloadFinished, this, &WidgetFileRepair::downloadFinished, Qt::QueuedConnection );
    connect( m_pObjFileRepair, &ObjFileRepair::sigUpdateDownload, this, &WidgetFileRepair::updateDownload, Qt::QueuedConnection );
