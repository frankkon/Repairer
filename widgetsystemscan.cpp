    ...
    ui(new Ui::WidgetSystemScan)
{
    ...
    //信号槽
    connect(this, &WidgetSystemScan::sigStartCheckDlls, m_pObjSysScan, &ObjSystemScan::startCheckDlls,
            Qt::BlockingQueuedConnection);
    connect(m_pObjSysScan, &ObjSystemScan::sigCurrentCheckFile, this, &WidgetSystemScan::updateCurrentCheckFile,
            Qt::AutoConnection);
    connect(m_pObjSysScan, &ObjSystemScan::sigAddFileToTable, this, &WidgetSystemScan::addFileToTable,
            Qt::QueuedConnection);
    connect(m_pObjSysScan, &ObjSystemScan::sigDownloadFinished, this, &WidgetSystemScan::downloadFinished,
            Qt::QueuedConnection);
    connect(m_pObjSysScan, &ObjSystemScan::sigCurrentDownloadFile, this, &WidgetSystemScan::updateCurrentDownloadFile,
            Qt::QueuedConnection);
