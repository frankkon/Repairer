...
CWin7X64DiskScanConfig::CWin7X64DiskScanConfig()
{

}

//返回需要扫描的目录信息列表
QList<TDiskScanInfo*>* CWin7X64DiskScanConfig::getDiskScanInfo()
{
    //已经加载过了，则直接返回
    ...
    QString sSql = "select platform_id,platform_name,platform_cpu,"
                   ...
                   " from disk_scan_info where platform_id=61 and platform_cpu=1";
...
QList<TRegScanInfo*>* CWin7X64DiskScanConfig::getRegScanInfo()
{
    //已经加载过了，则直接返回
    ...
    QString sSql = "select platform_id,platform_name,platform_cpu,"
                   ...
                   " from reg_scan_info where platform_id=61 and platform_cpu=1";
